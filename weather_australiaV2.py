...
pages = ["Introduction", "Datasets", "Exploration des données et visualisation", "Choix de l'algorithme", "Modélisation", "Prédiction", "Conclusions"]
...
if page == pages[4]: 
    ...
    Ci-après vous trouverez tous les résultats chiffrés.\n

    """)
    st.subheader("Dataset avec et sans OverSampling")
    st.markdown("""
