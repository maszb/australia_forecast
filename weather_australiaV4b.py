...
pages = ["Introduction", "Datasets", "Exploration des données et visualisation", "Algorithme de traitement des NaN", "Modélisation", "Conclusions","Restitution graphique des prédictions", "Entrainez les modèles ! ","Lancez une prédiction"]
...
if page == pages[5]:
    ...
    """)if page == pages[7]:    st.header("Choisissez les modèles à entrainer et la région ou le continent")if page == pages[8]:
