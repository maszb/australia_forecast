...
pages = ["Introduction", "Datasets", "Exploration des données et visualisation", "Algorithme de traitement des NaN", "Modélisation", "Conclusions","Restitution des prédictions", "Simulation"]
